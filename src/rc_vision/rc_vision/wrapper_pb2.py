...
import rc_vision.messages_robocup_ssl_detection_pb2 as messages__robocup__ssl__detection__pb2
import rc_vision.messages_robocup_ssl_geometry_pb2 as messages__robocup__ssl__geometry__pb2
