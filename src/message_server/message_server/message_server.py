...
from message_server.message_server_publisher import MessageServerPublisher
...
class MessageServer:
    ...
    def __init__(self, node: Node,
        ...
        from message_server.message_server_subscriber import MessageServerSubscriber
